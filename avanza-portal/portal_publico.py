    ...
    PLANES_VENTA = [
        {
            ...
            "u_items": ["Landing page profesional", "Mensaje comercial estratégico", "Formulario de contacto + WhatsApp", "Captación básica de leads", "Diseño responsive", "Presencia en Google Maps", "Configuración inicial de métricas", "✅ Hosting + Dominio + SSL incluidos el primer año"],
        ...
        },
        {
            ...
            "u_items": ["Todo lo del Plan Base, más:", "Web multi-sección (hasta 6 páginas)", "Lead magnet o formulario avanzado", "Integración con CRM / Email Marketing", "Automatización de respuesta", "Copywriting orientado a ventas", "✅ Hosting + Dominio + SSL incluidos el primer año"],
        ...
        },
        {
            ...
            "u_items": ["Todo lo del Plan Pro, más:", "Arquitectura de embudo de ventas", "Formularios segmentados", "Integración con CRM avanzado", "Panel de métricas en tiempo real", "Capacitación básica al equipo", "✅ Hosting + Dominio + SSL incluidos el primer año"],
        ...
        },
        {
            ...
            "u_items": ["Todo lo del Plan Industrial, más:", "Desarrollo a medida (Cotizador / Intranet)", "Integración bidireccional (Tango, SAP, CRMs)", "Automatización condicional y Lead Scoring", "Plan estratégico B2B y Auditoría comercial", "Garantía extendida (12 meses) y Soporte SLA", "Creación de Lead Magnet y contenidos", "✅ Hosting + Dominio + SSL incluidos el primer año"],

...
const PLANES = { 'Plan Base':1190, 'Plan Pro':3490, 'Plan Industrial':6990, 'Estrategico 360':9999 };
...
async function mostrarInstruccionesUSDT() {
  ...
  try {
    ...
    const PLAN_PRECIOS = {
      'Plan Base': 1190, 'Plan Pro': 3490,
      'Plan Industrial': 6990, 'Estratégico 360': 9999
    };
...
const _PERF_PLANES   = { "Plan Base": 1190, "Plan Pro": 3490, "Plan Industrial": 6990, "Estrategico 360": 9999 };
const _PERF_RUBROS   = {
...
function _perfilarLeadBolsaLocal(empresa, rubro, tamano, urgencia) {
  ...
  const ticket = (_PERF_PLANES[plan] || 3490) * mult;
...
const ACADEMIA_MODULOS = [
  {
    ...
    content: `
      ...
      <table class="aca-table">
        ...
        <tbody>
          <tr><td>Base</td><td>USD 1.190</td><td>USD 105</td><td>USD 126</td><td>USD 157</td><td>USD 210</td></tr>
          <tr><td>Pro</td><td>USD 3.490</td><td>USD 290</td><td>USD 348</td><td>USD 435</td><td>USD 580</td></tr>
          <tr><td>Industrial</td><td>USD 6.990</td><td>USD 490</td><td>USD 588</td><td>USD 735</td><td>USD 980</td></tr>
          <tr><td>Estratégico 360</td><td>USD 9.999</td><td>USD 750</td><td>USD 900</td><td>USD 1.125</td><td>USD 1.500</td></tr>
        </tbody>
      </table>
  ...
  },
  {
    ...
    content: `
      ...
      <table class="aca-table">
        ...
        <tbody>
          <tr><td>Metalúrgica · Fábrica · Agroindustria</td><td>Industrial (USD 6.990)</td><td>4–8 semanas</td></tr>
          <tr><td>Transporte · Logística · Distribución</td><td>Pro (USD 3.490)</td><td>2–4 semanas</td></tr>
          <tr><td>Servicios técnicos · Mantenimiento · Construcción</td><td>Base (USD 1.190)</td><td>1–2 semanas</td></tr>
          <tr><td>Parque industrial · Desarrollo · Corporativo +100</td><td>Estratégico 360 (USD 9.999)</td><td>8–12 semanas</td></tr>
        </tbody>
      </table>
  ...
  },
  {
    ...
    content: `
      ...
      <h3>Plan Industrial · USD 6.990</h3>
      ...
      <h3>Estratégico 360 · USD 9.999</h3>
      ...
      <table class="aca-table">
        ...
        <tbody>
          <tr><td>"No tengo presencia digital"</td><td><strong>Base (USD 1.190)</strong></td></tr>
          <tr><td>"Tengo web pero no me sirve"</td><td><strong>Pro (USD 3.490)</strong></td></tr>
          <tr><td>"Vendo productos técnicos complejos"</td><td><strong>Industrial (USD 6.990)</strong></td></tr>
          <tr><td>"Uso Tango/SAP y quiero integrar todo"</td><td><strong>Estratégico 360 (USD 9.999)</strong></td></tr>
          <tr><td>"Soy un desarrollador inmobiliario"</td><td><strong>Estratégico 360 (USD 9.999)</strong></td></tr>
          <tr><td>"Soy corporativo, tengo +100 empleados"</td><td><strong>Estratégico 360 (USD 9.999)</strong></td></tr>
        </tbody>
      </table>
  ...
  },
  {
    ...
    content: `
      ...
      <table class="aca-table">
        ...
        <tbody>
          <tr><td>Metalúrgica · Fábrica · Agroindustria · Alimentos</td><td>Aleametal</td><td><strong>Industrial USD 6.990</strong></td></tr>
          <tr><td>Transporte · Logística · Distribución · Mayorista</td><td>Logística Cordillera</td><td><strong>Pro USD 3.490</strong></td></tr>
          <tr><td>Servicios técnicos · Mantenimiento · Construcción</td><td>Soluciones Técnicas Generales</td><td><strong>Base USD 1.190</strong></td></tr>
          <tr><td>Parque industrial · Desarrollo · Corporativo +100</td><td>PLI Norte Argentino</td><td><strong>Estratégico 360 USD 9.999</strong></td></tr>
        </tbody>
      </table>
      ...
      <div class="aca-pitch-box">
        ...
        <div class="text">Hola [Nombre], como charlamos, te dejo el caso de Aleametal en Perú — mismo rubro que [empresa]. Tenían el mismo problema de presupuestos que se perdían. En 21 días montaron el sistema y mejoraron un 47% la conversión.<br><br>Te paso el brochure y el detalle del Plan Industrial (USD 6.990). Si querés avanzar, coordinamos una llamada de 15 minutos con el equipo técnico para arrancar. ¿Esta semana te queda bien?</div>
      </div>
      ...
      <div class="aca-pitch-box">
        <div class="label">MENSAJE DE WHATSAPP (TRAS EL SÍ)</div>
        <div class="text">Hola [Nombre], como charlamos, te paso el caso de Logística Cordillera en Chile. Pasaron de tardar 31hs a 4hs en responder cotizaciones y cerraron 3 contratos nuevos el primer mes.<br><br>Te dejo el brochure y el detalle del Plan Pro (USD 3.490). Si te cierra, coordinamos llamada técnica de 15 minutos para arrancar. ¿Esta semana o la próxima?</div>
      </div>
      ...
      <div class="aca-highlight">
        <div class="label">▸ PREGUNTA DE CIERRE</div>
        <div class="text">"Por USD 1.190 arrancás en 7 días. Con una sola consulta nueva al mes ya te conviene, ¿no?"</div>
      </div>
      ...
      <div class="aca-highlight">
        <div class="label">▸ PREGUNTA DE CIERRE</div>
        <div class="text">"El Estratégico 360 son USD 9.999, pago único. Una sola empresa o inversor captado por el sistema lo paga. ¿Avanzamos?"</div>
      </div>
  ...
  },
  {
    ...
    content: `
      ...
      <div class="aca-objection">
        ...
        <div class="a">"USD 3.490 es mucho para mí ahora." / "Está fuera de mi presupuesto."</div>
      </div>
  ...
  },
  {
    ...
    icon: 'fa-trophy',
    content: `
      <div class="av-explainer"><div class="av-tag"><i class="fa-solid fa-circle-play"></i> Prueba social &middot; M&Oacute;DULO 07</div><div class="av-stage"><div class="av-slide center" data-dur="5500"><div class="av-kicker r d1">Prueba social &middot; M&oacute;dulo 07</div><div class="av-h r d2">Casos de &eacute;xito,<br>con <span class="g">n&uacute;meros</span></div><div class="av-sub r d3">Cuatro casos reales, uno por rubro. Memoriz&aacute; el resultado en una l&iacute;nea: los n&uacute;meros cierran ventas.</div></div><div class="av-slide" data-dur="7500"><div class="av-kicker r d1">Aleametal &middot; Perú</div><div class="av-row r d2" style="gap:10px"><div class="av-kpi"><div class="v">+47%</div><div class="k">conversi&oacute;n</div></div><div class="av-kpi"><div class="v">21</div><div class="k">d&iacute;as implementaci&oacute;n</div></div><div class="av-kpi"><div class="v">11</div><div class="k">leads calif./mes</div></div></div><div class="av-quote r d3"><span class="lab">En una l&iacute;nea</span>38 empleados, consultas por 3 canales sin control &rarr; panel &uacute;nico. <b>0 consultas sin respuesta en 24hs</b> y recuperaron 2 clientes grandes. &rarr; Industrial USD 6.990.</div></div><div class="av-slide" data-dur="7500"><div class="av-kicker r d1">Transportes Logística Cordillera &middot; Rosario</div><div class="av-stat r d2"><span class="o">31h</span> &rarr; <span class="g">4.2h</span></div><div class="av-quote r d3"><span class="lab">En una l&iacute;nea</span>22 empleados, cotizaciones por 4 canales que se duplicaban. Hoy responden autom&aacute;tico: <b>+38% de cierre y 3 contratos nuevos el primer mes</b>. &rarr; Pro USD 3.490.</div></div><div class="av-slide" data-dur="7500"><div class="av-kicker r d1">Soluciones Técnicas Generales &middot; Argentina</div><div class="av-stat r d2 g">USD 8.400</div><div class="av-quote r d3"><span class="lab">En una l&iacute;nea</span>9 empleados, 12 a&ntilde;os, solo por referidos. Plan Base en 7 d&iacute;as &rarr; <b>3-4 clientes nuevos/mes, 1&ordm; en Google local y USD 8.400 en contratos el primer trimestre</b>. El plan se pag&oacute; con la 1&ordf; venta.</div></div><div class="av-slide" data-dur="7000"><div class="av-kicker r d1">PLI Norte Argentino &middot; gran escala</div><div class="av-grid g3"><div class="av-card r d2"><div class="n">120 ha</div><div class="d">superficie</div></div><div class="av-card r d3"><div class="n o">89</div><div class="d">lotes</div></div><div class="av-card r d4"><div class="n g">360</div><div class="d">Andreani, Grido, YPF</div></div></div><div class="av-sub r d5">El caso de autoridad: aunque lo tuyo sea m&aacute;s chico, el enfoque es el mismo. &rarr; Estrat&eacute;gico 360 USD 9.999.</div></div><div class="av-slide center" data-dur="6500"><div class="av-quote r d1"><span class="lab">C&oacute;mo usar los casos</span>Eleg&iacute; el del <b>rubro del cliente</b> y cont&aacute; el antes/despu&eacute;s con los n&uacute;meros. Si vas con Aleametal a un transportista, no se reconoce. El caso correcto cierra <b>3&times; m&aacute;s</b>.</div></div></div><div class="av-controls"><button class="av-btn prev" aria-label="Anterior"><i class="fa-solid fa-backward-step"></i></button><button class="av-btn play" aria-label="Pausar"><i class="fa-solid fa-pause"></i></button><button class="av-btn next" aria-label="Siguiente"><i class="fa-solid fa-forward-step"></i></button><div class="av-progress"><div class="av-progress-fill"></div></div><div class="av-dots"></div><div class="av-counter">1 / 1</div></div></div>
      ...
      <p><strong>Plan contratado:</strong> Base · USD 1.190 · Implementación 7 días</p>
      ...
      <p><strong>Plan contratado:</strong> Pro · USD 3.490 · Implementación 14 días</p>
      <h4>Problema antes</h4>
      ...
      <p><strong>Plan contratado:</strong> Industrial · USD 6.990 · Implementación 21 días</p>
      <h4>Problema antes</h4>
      ...
      <p><strong>Plan contratado:</strong> Estratégico 360 · USD 9.999 · Implementación 45-60 días</p>
      <h4>El desafío</h4>

...
function renderAlertas() {
  ...
  const sinSeguimiento = todosProspectos.filter(p=>p.estado==='contactado').length;
  ...
  if(sinSeguimiento>0)
    html += `<div style="background:rgba(245,158,11,0.1);border:1px solid rgba(245,158,11,0.25);border-radius:10px;padding:12px 16px;margin-bottom:12px;font-size:.88rem;font-weight:600;color:#f59e0b;">
      <i class="fa-solid fa-clock"></i> &nbsp;Tenés <strong>${sinSeguimiento}</strong> sin seguimiento — contactaste pero no respondieron
    </div>`;
  if(conPropuesta>0)
...
function plRenderAlertas() {
  ...
  const sinSeguimiento = todosProspectosPipeline.filter(p=>p.estado==='contactado').length;
  ...
  if(sinSeguimiento>0)
    html += `<div style="background:rgba(245,158,11,0.1);border:1px solid rgba(245,158,11,0.25);border-radius:10px;padding:12px 16px;margin-bottom:12px;font-size:.88rem;font-weight:600;color:#f59e0b;">
      <i class="fa-solid fa-clock"></i> &nbsp;Tenés <strong>${sinSeguimiento}</strong> sin seguimiento
    </div>`;
  if(conPropuesta>0)
    html += `<div style="background:rgba(59,130,246,0.08);border:1px solid rgba(59,130,246,0.25);border-radius:10px;padding:12px 16px;margin-bottom:16px;font-size:.88rem;font-weight:600;color:var(--primary);">
      <i class="fa-solid fa-file-invoice"></i> &nbsp;Tenés <strong>${conPropuesta}</strong> propuesta${conPropuesta>1?'s':''} enviada${conPropuesta>1?'s':''} esperando respuesta
...
const ACADEMIA_MODULOS = [
  ...
  },
  {
    ...
    content: `
      ...
      <div class="aca-pitch-box">
        ...
        <div class="text">"Te cuento rápido. <strong>Metalúrgica Balconi en Rafaela</strong> tenía exactamente lo que me acabás de describir — 38 empleados, consultas por 3 canales distintos, 40% de presupuestos sin seguimiento. En 21 días les armamos un sistema. Hoy tienen +47% de conversión y cero consultas sin respuesta en 24hs. El Plan Industrial — USD 4.900, pago único."</div>
      </div>
      ...
      <div class="aca-pitch-box">
        ...
        <div class="text">"Entiendo. Te mando el brochure con el caso de [Balconi/Oñate/Cufré] por WhatsApp ahora, y te vuelvo a escribir el viernes para ver qué pensaste. Sin presión."</div>
      </div>
  ...
  },
  {
    ...
    content: `
      ...
      <table class="aca-table">
        ...
        <tbody>
          <tr><td>Metalúrgica · Fábrica · Agroindustria · Alimentos</td><td>Metalúrgica Balconi</td><td><strong>Industrial USD 4.900</strong></td></tr>
          <tr><td>Transporte · Logística · Distribución · Mayorista</td><td>Transportes Oñate</td><td><strong>Pro USD 2.900</strong></td></tr>
          <tr><td>Servicios técnicos · Mantenimiento · Construcción</td><td>Soluciones Técnicas del Litoral</td><td><strong>Base USD 1.050</strong></td></tr>
      ...
      <div class="aca-pitch-box">
        ...
        <div class="text">Hola [Nombre], como charlamos, te dejo el caso de Metalúrgica Balconi en Rafaela — mismo rubro que [empresa]. Tenían el mismo problema de presupuestos que se perdían. En 21 días montaron el sistema y mejoraron un 47% la conversión.<br><br>Te paso el brochure y el detalle del Plan Industrial (USD 4.900). Si querés avanzar, coordinamos una llamada de 15 minutos con el equipo técnico para arrancar. ¿Esta semana te queda bien?</div>
      </div>

      <h3>Caso 2 · Transporte, Logística, Distribución</h3>
      <div class="aca-pitch-box">
        <div class="label">PITCH VERBAL</div>
        <div class="text">"Hay un caso que te puede interesar. <strong>Transportes Oñate Hermanos, en Rosario</strong>. 22 empleados. Recibían cotizaciones por 4 canales distintos. Tardaban 31 horas en contestar un presupuesto. En transporte eso es muerte — el cliente cotiza con la competencia. <strong>En 14 días les montamos el sistema</strong>. Hoy responden en 4 horas automáticamente y cerraron 3 contratos nuevos el primer mes."</div>
      </div>
      <div class="aca-highlight">
        <div class="label">▸ PREGUNTA DE CIERRE</div>
      ...
      <div class="aca-pitch-box">
        <div class="label">MENSAJE DE WHATSAPP (TRAS EL SÍ)</div>
        <div class="text">Hola [Nombre], como charlamos, te paso el caso de Transportes Oñate en Rosario. Pasaron de tardar 31hs a 4hs en responder cotizaciones y cerraron 3 contratos nuevos el primer mes.<br><br>Te dejo el brochure y el detalle del Plan Pro (USD 2.900). Si te cierra, coordinamos llamada técnica de 15 minutos para arrancar. ¿Esta semana o la próxima?</div>
      </div>

      <h3>Caso 3 · Servicios técnicos, Mantenimiento, Construcción</h3>
      <div class="aca-pitch-box">
        <div class="label">PITCH VERBAL</div>
        <div class="text">"Te cuento un caso ideal para empresas de tu perfil. <strong>Soluciones Técnicas del Litoral, en Paraná</strong>. 9 empleados, 12 años en el mercado. Conseguían clientes solo por referidos. <strong>En 7 días montamos el Plan Base</strong>. A los 20 días les entró la primera consulta de una empresa con la que nunca habían tenido contacto. USD 8.400 en contratos nuevos el primer trimestre. El plan se pagó solo con la primera venta."</div>
      </div>
      <div class="aca-highlight">
        <div class="label">▸ PREGUNTA DE CIERRE</div>
      ...
      <div class="aca-tip">
        <div class="label">REGLA DE ORO</div>
        <div class="text">Un aliado que usa el caso correcto del rubro cierra <strong>3 veces más</strong> que uno que improvisa. Si vas con Balconi a un transportista, el cliente no se reconoce. Si vas con Oñate a una metalúrgica, tampoco. Memoriza los 4 casos por rubro — eso solo te cambia el resultado del mes.</div>
      </div>
    `
  },
  {
    ...
    content: `
      ...
      <div class="aca-pitch-box">
        <div class="label">LO QUE DECÍS</div>
        <div class="text">"Balconi también lo usaba. <strong>El problema no es tener WhatsApp, es que nadie ve lo que pasa ahí adentro.</strong> Si hoy el vendedor atiende y no cierra, ¿vos como dueño cómo te enterás? Lo que agregamos es el panel que unifica WhatsApp, email y teléfono, con etapas visibles y seguimiento automático. Por eso Balconi recuperó dos clientes grandes que ya habían dado por perdidos."</div>
      </div>
  ...
  },
  {
    ...
    icon: 'fa-trophy',
    content: `
      <div class="av-explainer"><div class="av-tag"><i class="fa-solid fa-circle-play"></i> Prueba social &middot; M&Oacute;DULO 07</div><div class="av-stage"><div class="av-slide center" data-dur="5500"><div class="av-kicker r d1">Prueba social &middot; M&oacute;dulo 07</div><div class="av-h r d2">Casos de &eacute;xito,<br>con <span class="g">n&uacute;meros</span></div><div class="av-sub r d3">Cuatro casos reales, uno por rubro. Memoriz&aacute; el resultado en una l&iacute;nea: los n&uacute;meros cierran ventas.</div></div><div class="av-slide" data-dur="7500"><div class="av-kicker r d1">Metal&uacute;rgica Balconi &middot; Rafaela</div><div class="av-row r d2" style="gap:10px"><div class="av-kpi"><div class="v">+47%</div><div class="k">conversi&oacute;n</div></div><div class="av-kpi"><div class="v">21</div><div class="k">d&iacute;as implementaci&oacute;n</div></div><div class="av-kpi"><div class="v">11</div><div class="k">leads calif./mes</div></div></div><div class="av-quote r d3"><span class="lab">En una l&iacute;nea</span>38 empleados, consultas por 3 canales sin control &rarr; panel &uacute;nico. <b>0 consultas sin respuesta en 24hs</b> y recuperaron 2 clientes grandes. &rarr; Industrial USD 4.900.</div></div><div class="av-slide" data-dur="7500"><div class="av-kicker r d1">Transportes O&ntilde;ate &middot; Rosario</div><div class="av-stat r d2"><span class="o">31h</span> &rarr; <span class="g">4.2h</span></div><div class="av-quote r d3"><span class="lab">En una l&iacute;nea</span>22 empleados, cotizaciones por 4 canales que se duplicaban. Hoy responden autom&aacute;tico: <b>+38% de cierre y 3 contratos nuevos el primer mes</b>. &rarr; Pro USD 2.900.</div></div><div class="av-slide" data-dur="7500"><div class="av-kicker r d1">Soluciones T&eacute;cnicas del Litoral &middot; Paran&aacute;</div><div class="av-stat r d2 g">USD 8.400</div><div class="av-quote r d3"><span class="lab">En una l&iacute;nea</span>9 empleados, 12 a&ntilde;os, solo por referidos. Plan Base en 7 d&iacute;as &rarr; <b>3-4 clientes nuevos/mes, 1&ordm; en Google local y USD 8.400 en contratos el primer trimestre</b>. El plan se pag&oacute; con la 1&ordf; venta.</div></div><div class="av-slide" data-dur="7000"><div class="av-kicker r d1">PLI Norte Argentino &middot; gran escala</div><div class="av-grid g3"><div class="av-card r d2"><div class="n">120 ha</div><div class="d">superficie</div></div><div class="av-card r d3"><div class="n o">89</div><div class="d">lotes</div></div><div class="av-card r d4"><div class="n g">360</div><div class="d">Andreani, Grido, YPF</div></div></div><div class="av-sub r d5">El caso de autoridad: aunque lo tuyo sea m&aacute;s chico, el enfoque es el mismo. &rarr; Estrat&eacute;gico 360 USD 7.500.</div></div><div class="av-slide center" data-dur="6500"><div class="av-quote r d1"><span class="lab">C&oacute;mo usar los casos</span>Eleg&iacute; el del <b>rubro del cliente</b> y cont&aacute; el antes/despu&eacute;s con los n&uacute;meros. Si vas con Balconi a un transportista, no se reconoce. El caso correcto cierra <b>3&times; m&aacute;s</b>.</div></div></div><div class="av-controls"><button class="av-btn prev" aria-label="Anterior"><i class="fa-solid fa-backward-step"></i></button><button class="av-btn play" aria-label="Pausar"><i class="fa-solid fa-pause"></i></button><button class="av-btn next" aria-label="Siguiente"><i class="fa-solid fa-forward-step"></i></button><div class="av-progress"><div class="av-progress-fill"></div></div><div class="av-dots"></div><div class="av-counter">1 / 1</div></div></div>
      ...
      <h3>🔧 Soluciones Técnicas del Litoral S.R.L.</h3>
      <p><strong>Perfil:</strong> Mantenimiento y calibración industrial · Paraná, Entre Ríos · 9 empleados</p>
      ...
      <ul>
        ...
        <li><strong>1° puesto en Google local</strong> para su rubro en Paraná</li>
        <li><strong>USD 8.400</strong> en contratos nuevos el primer trimestre</li>
      </ul>

      <h3>🚚 Transportes Oñate Hermanos S.A.</h3>
      <p><strong>Perfil:</strong> Transporte de cargas regional · Rosario, Santa Fe · 22 empleados</p>
      ...
      <h3>🏭 Metalúrgica Balconi S.R.L.</h3>
      <p><strong>Perfil:</strong> Fabricación de equipos para agroindustria · Rafaela, Santa Fe · 38 empleados</p>
      ...
      <div class="aca-pitch-box">
        <div class="text">"Antes yo mismo revisaba el WhatsApp del vendedor. Hoy entro al panel y en dos minutos sé qué presupuesto está caliente." — Santiago Balconi, Socio Gerente</div>
      </div>
  ...
  },
  {
    ...
    content: `
      ...
      <div class="d-canal1-only">
        ...
        <div class="aca-downloads">
          <a class="aca-download" href="#" onclick="descargarPDF('https://drive.google.com/uc?export=download&id=1DcfwVhAtijPvfARqHdqP7MVZNcZ6Gbsl','Brochure_Comercial_AvanzaDigital_v4.pdf');return false;">
      ...
      <div class="aca-downloads">
        <a class="aca-download" href="#" onclick="descargarPDF('https://drive.google.com/uc?export=download&id=1qnj6IwmBDmodEyjFHUiejKsJc31DLiNY','Carrusel_Balconi_Canal1.pdf');return false;">
          <i class="fa-solid fa-layer-group" style="color:#f97316;"></i>
          <div><div class="dl-title">Caso Balconi (Metalúrgica)</div><div class="dl-sub">+47% conversión en 21 días</div></div>
        </a>
        <a class="aca-download" href="#" onclick="descargarPDF('https://drive.google.com/uc?export=download&id=1vss3SR6MHvUNiyhonIyWjJpZUhhuqWFP','Carrusel_Onate_Canal1.pdf');return false;">
          <i class="fa-solid fa-layer-group" style="color:#f97316;"></i>
          <div><div class="dl-title">Caso Oñate (Logística)</div><div class="dl-sub">De 31hs a 4hs de respuesta · +38% cierre</div></div>
        </a>
        <a class="aca-download" href="#" onclick="descargarPDF('https://drive.google.com/uc?export=download&id=1ztWe9BqnDWnknvbM4L9RcmOLQixSQ9qw','Carrusel_Litoral_Canal1.pdf');return false;">
          <i class="fa-solid fa-layer-group" style="color:#f97316;"></i>
          <div><div class="dl-title">Caso Litoral (Servicios técnicos)</div><div class="dl-sub">USD 8.400 en contratos · 1° en Google local</div></div>
        </a>
      ...
      <div class="aca-pitch-box">
        <div class="text">"Hola [Nombre], como charlamos, te paso el brochure con los 4 planes y los casos de éxito. En la página 5 está el caso de [Balconi/Oñate/Cufré] que te va a interesar. Si te cierra alguno, coordinamos llamada técnica. ¿Esta semana?"</div>
      </div>
  ...
  // ── MÓDULO 8 · CANAL 2 ──────────────────────────────────────────────────────
  {
    ...
    content: `
      ...
      <div class="aca-highlight" style="margin-bottom:1rem;">
        ...
        <div class="text">Abrís el <strong>Guión por Rubro</strong>, encontrás el caso que más se parece a su empresa (Balconi = metalúrgica/fábrica; Oñate = transporte/logística; Sol. Técnicas = servicios/mantenimiento; PLI = proyectos de escala) y contás ese caso con el pitch verbal que está en el guión.</div>
      </div>
      ...
      <table class="aca-table">
        ...
        <tbody>
          <tr>
            ...
            <td>"Una metalúrgica de Rafaela tenía el 40% de sus presupuestos sin seguimiento. Implementamos un sistema de alertas automáticas. Resultado: +62% de cotizaciones respondidas en menos de 4hs."</td>
          </tr>
          <tr>
